...
echo " 					Readme for ghcr.io/suwayomi/tachidesk is avilable at https://github.com/suwayomi/docker-tachidesk (only alpine multiarch based docker images)  "
echo "								Old Readme for docker.io/arbuild/tachidesk-docker is avilable at https://github.com/arbuilder/Tachidesk-docker"
echo "                                                                *****************************"
echo ""
echo ""
